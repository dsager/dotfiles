...
[core]
s0_active_plugins = core;composite;opengl;wall;regex;grid;compiztoolbox;workarounds;resize;snap;move;imgpng;commands;place;expo;session;scale;unityshell;
s0_autoraise = false
...
s0_outline_color = #729fcfff
s0_fill_color = #204a874f
...
[rotate]
s0_rotate_left_key = <Super>Left
s0_rotate_right_key = <Super>Right
s0_rotate_left_window_key = <Alt><Super>Left
s0_rotate_right_window_key = <Alt><Super>Right
...
s0_up_window_key = <Alt><Super>Up
s0_down_window_key = <Alt><Super>Down
